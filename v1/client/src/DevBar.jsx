...
const ACCOUNTS = [
  { email: 'fatima@demo.wigofly.app', label: 'Fatima', role: 'Expéditrice' },
  { email: 'karim@demo.wigofly.app', label: 'Karim', role: 'Voyageur' },
  { email: 'mehdi@demo.wigofly.app', label: 'Mehdi', role: 'Destinataire' },
  { email: 'admin@demo.wigofly.app', label: 'Admin', role: 'Back-office' },
];
