...
const SECTIONS = [
  {
    ...
    body: (
      <>
        <p>
          Salama (ci-après « <b>nous</b> », « <b>la Plateforme</b> ») est responsable du traitement des données
        ...
        <p>
          ...
          Données : <a href="mailto:dpo@salama.app">dpo@salama.app</a>.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ul className="checklist">
          ...
          <li><b>Prestataire de paiement agréé</b> (escrow) — pour séquestrer et verser les fonds. Salama ne détient jamais vos fonds ni vos coordonnées bancaires complètes.</li>
  ...
  return (
    <div>
      ...
      <div className="card center" style={{ padding: '20px 18px' }}>
        ...
        <a href="mailto:dpo@salama.app" style={{ fontWeight: 700, color: 'var(--accent)', textDecoration: 'none' }}>
          dpo@salama.app
        </a>
      </div>
    </div>
