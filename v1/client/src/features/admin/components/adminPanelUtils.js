...
export function auditAction(action) {
  const keys = {
    ...
    'admin.member_case.view': 'admin.audit.memberCaseViewed',
    'manual_payout_countries_viewed': 'admin.audit.payoutCountriesViewed',
    'manual_payout_queue_viewed': 'admin.audit.payoutQueueViewed',
    'manual_payout_account_saved': 'admin.audit.payoutAccountSaved',
    'manual_payout_requested': 'admin.audit.payoutRequested',
    'manual_payout_sent': 'admin.audit.payoutSent',
    'stripe_checkout_created': 'admin.audit.checkoutCreated',
    'stripe_refund_created': 'admin.audit.refundCreated',
    'role.admin.grant': 'admin.audit.adminGranted',
    'role.admin.revoke': 'admin.audit.adminRevoked',
    'user.safety.warn': 'admin.audit.userWarned',
    'user.safety.suspend': 'admin.audit.userSuspended',
    'user.safety.restore': 'admin.audit.userRestored',
    'user.safety.appeal': 'admin.audit.safetyAppealCreated',
    'user.safety.appeal.accept': 'admin.audit.safetyAppealAccepted',
    'user.safety.appeal.reject': 'admin.audit.safetyAppealRejected',
    'conversation.report': 'admin.audit.conversationReported',
    'conversation.block': 'admin.audit.conversationBlocked',
    'conversation.unblock': 'admin.audit.conversationUnblocked',
    'user.unblock': 'admin.audit.userUnblocked',
    'support.request.create': 'admin.audit.supportRequestCreated',
    'custom_whitelist.remove': 'admin.audit.whitelistRemoved',
    'operation_pickup_code_issued': 'admin.audit.pickupCodeIssued',
    'operation_pickup_code_failed': 'admin.audit.pickupCodeFailed',
    'operation_pickup_code_verified': 'admin.audit.pickupCodeVerified',
    'operation_delivery_code_issued': 'admin.audit.deliveryCodeIssued',
    'operation_delivery_code_failed': 'admin.audit.deliveryCodeFailed',
    'operation_delivery_code_verified': 'admin.audit.deliveryCodeVerified',
    'maintenance.message_media': 'admin.audit.messageMediaMigrated',
    'maintenance.kyc_media': 'admin.audit.kycMediaMigrated',
    'maintenance.profile_media': 'admin.audit.profileMediaMigrated',
    'review.listing.approve': 'admin.audit.listingApproved',
    'review.listing.reject': 'admin.audit.listingRejected',
    'review.dispute.release_traveler': 'admin.audit.disputeReleasedToTraveler',
    'review.dispute.refund_sender': 'admin.audit.disputeRefundedToSender',
    'review.conversation.conversation_dismissed': 'admin.audit.conversationDismissed',
    'review.conversation.conversation_watch': 'admin.audit.conversationWatched',
  };
