  ...
  fr: {
    ...
    sections: [
      { id: 'controller', title: '1. Responsable du traitement', paragraphs: [
        'Le responsable du traitement est [À COMPLÉTER - raison sociale de Wigofly], établi à [À COMPLÉTER - adresse du siège].',
      ...
      { id: 'location', title: '4. Localisation', paragraphs: [
        'Wigofly ne suit pas votre position en continu. La localisation n’est lue qu’après votre action dans une conversation et l’autorisation de votre navigateur. Vous pouvez choisir votre position actuelle ou un lieu de rendez-vous.',
      ...
      { id: 'recipients', title: '5. Destinataires et sous-traitants', list: [
        ...
        'Équipe Wigofly : accès limité aux dossiers, demandes de vérification, signalements et litiges selon le besoin d’intervention.',
      ...
      { id: 'retention', title: '6. Conservation et suppression', list: [
        ...
        'En cas de suppression du compte, Wigofly anonymise les données de profil lorsque cela est techniquement et légalement possible ; les éléments nécessaires à une obligation légale ou à un litige en cours peuvent être conservés.',
      ] },
      ...
      { id: 'security', title: '8. Sécurité, stockage local et cookies', paragraphs: [
        'Les mots de passe sont stockés sous forme hachée. Wigofly utilise des sessions, des protections contre les tentatives de connexion abusives et des contrôles de sécurité pour la messagerie et les comptes.',
      ...
      { id: 'transfers', title: '9. Transferts internationaux et modifications', paragraphs: [
        'Les emplacements réels de traitement et les mécanismes de transfert des sous-traitants doivent être confirmés dans leurs documents contractuels avant le lancement commercial. Si un transfert hors EEE est nécessaire, Wigofly mettra en place le mécanisme légal approprié et mettra cette politique à jour.',
  ...
  nl: {
    ...
    sections: [
      { id: 'controller', title: '1. Verwerkingsverantwoordelijke', paragraphs: [
        'De verwerkingsverantwoordelijke is [AAN TE VULLEN - wettelijke naam van Wigofly], gevestigd te [AAN TE VULLEN - adres van de maatschappelijke zetel].',
      ...
      { id: 'location', title: '4. Locatie', paragraphs: [
        'Wigofly volgt uw locatie niet voortdurend. De locatie wordt alleen gelezen na uw actie in een gesprek en na toestemming van uw browser. U kunt uw huidige locatie of een ontmoetingsplaats kiezen.',
      ...
      { id: 'recipients', title: '5. Ontvangers en verwerkers', list: [
        ...
        'Wigofly-team: beperkte toegang tot dossiers, verificatieverzoeken, meldingen en geschillen wanneer tussenkomst nodig is.',
      ...
      { id: 'retention', title: '6. Bewaring en verwijdering', list: [
        ...
        'Bij verwijdering van het account anonimiseert Wigofly profielgegevens waar dit technisch en juridisch mogelijk is. Elementen die nodig zijn voor een wettelijke verplichting of lopend geschil kunnen worden bewaard.',
      ] },
      ...
      { id: 'security', title: '8. Beveiliging, lokale opslag en cookies', paragraphs: [
        'Wachtwoorden worden gehasht opgeslagen. Wigofly gebruikt sessies, bescherming tegen misbruik van aanmeldpogingen en beveiligingscontroles voor berichten en accounts.',
      ...
      { id: 'transfers', title: '9. Internationale doorgiften en wijzigingen', paragraphs: [
        'Werkelijke verwerkingslocaties en doorgiftemechanismen van verwerkers moeten vóór de commerciële lancering in hun contracten worden bevestigd. Indien doorgifte buiten de EER nodig is, past Wigofly het juiste wettelijke mechanisme toe en werkt het dit beleid bij.',
  ...
  ar: {
    ...
    sections: [
      { id: 'controller', title: '1. المسؤول عن معالجة البيانات', paragraphs: [
        'المسؤول عن المعالجة هو [يُستكمل - الاسم القانوني لـ Wigofly]، ومقره [يُستكمل - عنوان المقر].',
      ...
      { id: 'location', title: '4. الموقع', paragraphs: [
        'لا يتتبع Wigofly موقعك باستمرار. لا يُقرأ الموقع إلا بعد قيامك بإجراء داخل محادثة ومنح إذن المتصفح. يمكنك اختيار موقعك الحالي أو مكان للقاء.',
      ...
      { id: 'recipients', title: '5. المستلمون ومعالجو البيانات', list: [
        ...
        'فريق Wigofly: وصول محدود إلى الملفات وطلبات التحقق والبلاغات والنزاعات عند الحاجة إلى التدخل.',
      ...
      { id: 'retention', title: '6. الاحتفاظ والحذف', list: [
        ...
        'عند حذف الحساب، يجهّل Wigofly بيانات الملف حيثما كان ذلك ممكنا تقنيا وقانونيا. ويمكن الاحتفاظ بالعناصر اللازمة لالتزام قانوني أو نزاع جارٍ.',
      ] },
      ...
      { id: 'security', title: '8. الأمان والتخزين المحلي وملفات الارتباط', paragraphs: [
        'تُخزّن كلمات المرور بصيغة مشفرة. يستخدم Wigofly الجلسات والحماية من محاولات الدخول المسيئة وضوابط أمان للرسائل والحسابات.',
      ...
      { id: 'transfers', title: '9. النقل الدولي والتعديلات', paragraphs: [
        'يجب تأكيد مواقع المعالجة الفعلية وآليات نقل بيانات المتعهدين في وثائقهم التعاقدية قبل الإطلاق التجاري. إذا لزم نقل خارج المنطقة الاقتصادية الأوروبية، سيطبق Wigofly الآلية القانونية المناسبة ويحدث هذه السياسة.',
  ...
  fr: {
    ...
    sections: [
      { id: 'editor', title: "1. Éditeur et champ d'application", paragraphs: [
        '{entity}, {address}, {registration}, exploite la plateforme Wigofly. Contact légal : {email}.',
        "Les présentes conditions encadrent l'utilisation du site, de l'application et des services Wigofly. Elles s'appliquent aux expéditeurs, voyageurs, destinataires et visiteurs. L'utilisation de Wigofly implique leur acceptation.",
      ...
      { id: 'role', title: '2. Rôle de Wigofly', paragraphs: [
        'Wigofly fournit un outil de mise en relation, de coordination, de messagerie, de vérification manuelle et de suivi des opérations. Wigofly ne transporte pas les colis, ne contrôle pas physiquement leur contenu et ne remplace ni un transporteur, ni un transitaire, ni un mandataire en douane.',
      ...
      { id: 'account', title: '3. Compte, sécurité et vérification', list: [
        ...
        "La publication de trajets et certaines actions peuvent exiger une vérification d'identité. La vérification est actuellement instruite par Wigofly ; un prestataire externe ne sera cité qu'après sa mise en service effective.",
      ...
      { id: 'products', title: '4. Produits, déclarations et douane', paragraphs: [
        ...
        "Un colis accepté dans Wigofly n'est pas automatiquement admis en douane. L'utilisateur doit vérifier les règles du pays de départ, de transit et d'arrivée.",
      ] },
      ...
      { id: 'payment', title: '6. Paiement et frais', paragraphs: [
        "État actuel du service : le module de paiement et de séquestre est simulé. Aucun paiement réel, encaissement, cantonnement ou versement n'est exécuté par Wigofly tant qu'un prestataire de paiement agréé et les conditions définitives ne sont pas actifs.",
        "Avant l'activation de paiements réels, Wigofly publiera le nom du prestataire, les frais, les conditions de remboursement, les délais de versement et les informations légalement requises. Les utilisateurs ne doivent jamais payer un autre utilisateur en dehors des moyens officiellement proposés par Wigofly.",
      ] },
      { id: 'chat', title: '7. Messagerie, photos et localisation', list: [
        'La coordination doit rester dans la messagerie Wigofly. Les numéros, emails, liens, réseaux sociaux et moyens de paiement externes peuvent être bloqués ou modérés pour protéger les utilisateurs.',
      ...
      { id: 'conduct', title: '8. Comportements interdits et modération', list: [
        ...
        "Harcèlement, menace, discrimination, pression pour communiquer hors application ou pour payer en dehors de Wigofly.",
      ...
      { id: 'liability', title: '10. Responsabilité', paragraphs: [
        "Dans les limites autorisées par la loi, Wigofly n'est pas responsable des déclarations des utilisateurs, de la qualité d'un produit, d'un retard de voyage, d'une décision douanière, d'un accord conclu hors application ou d'un dommage causé par un utilisateur.",
      ...
      { id: 'end', title: '11. Durée, fermeture et évolution des conditions', paragraphs: [
        "Vous pouvez cesser d'utiliser Wigofly et demander la suppression de votre compte depuis les réglages, sous réserve des obligations légales et des opérations en cours. Wigofly peut modifier ces conditions pour des raisons légales, de sécurité ou d'évolution du service ; les changements importants seront annoncés avant leur prise d'effet.",
  ...
  nl: {
    ...
    sections: [
      { id: 'editor', title: '1. Uitgever en toepassingsgebied', paragraphs: [
        '{entity}, {address}, {registration}, beheert het Wigofly-platform. Juridisch contact: {email}.',
        'Deze voorwaarden regelen het gebruik van de website, applicatie en diensten van Wigofly. Ze gelden voor verzenders, reizigers, ontvangers en bezoekers. Gebruik van Wigofly houdt aanvaarding ervan in.',
        'De informatie tussen haakjes moet vóór elke commerciële opening worden vervangen door de bedrijfsgegevens.',
      ] },
      { id: 'role', title: '2. Rol van Wigofly', paragraphs: [
        'Wigofly biedt hulpmiddelen voor matching, coördinatie, berichten, handmatige verificatie en opvolging van operaties. Wigofly vervoert geen pakketten, controleert de inhoud niet fysiek en vervangt geen vervoerder, expediteur of douanevertegenwoordiger.',
      ...
      { id: 'account', title: '3. Account, beveiliging en verificatie', list: [
        ...
        'Voor het publiceren van reizen en bepaalde acties kan identiteitsverificatie nodig zijn. Wigofly behandelt die momenteel zelf; een externe provider wordt pas na effectieve ingebruikname vermeld.',
      ...
      { id: 'products', title: '4. Producten, verklaringen en douane', paragraphs: [
        ...
        'Een in Wigofly aanvaard pakket is niet automatisch toegelaten door de douane. De gebruiker moet de regels van vertrek-, transit- en aankomstland controleren.',
      ] },
      ...
      { id: 'payment', title: '6. Betaling en kosten', paragraphs: [
        'Huidige toestand: de betalings- en bewaringsmodule is een simulatie. Wigofly voert geen echte betaling, inning, bewaring of uitbetaling uit zolang geen erkende betalingsprovider en definitieve voorwaarden actief zijn.',
        'Vóór echte betalingen publiceert Wigofly de provider, kosten, terugbetalingsvoorwaarden, uitbetalingstermijnen en wettelijk vereiste informatie. Gebruikers mogen elkaar nooit buiten de officieel aangeboden Wigofly-middelen betalen.',
      ] },
      { id: 'chat', title: '7. Berichten, foto’s en locatie', list: [
        'Coördinatie moet in Wigofly-berichten blijven. Telefoonnummers, e-mails, links, sociale netwerken en externe betaalmiddelen kunnen ter bescherming worden geblokkeerd of gemodereerd.',
      ...
      { id: 'liability', title: '10. Aansprakelijkheid', paragraphs: [
        'Binnen de wettelijke grenzen is Wigofly niet aansprakelijk voor verklaringen van gebruikers, productkwaliteit, reisvertraging, douanebeslissingen, afspraken buiten de app of schade door een gebruiker.',
      ...
      { id: 'end', title: '11. Duur, sluiting en wijziging', paragraphs: [
        'U kunt Wigofly niet meer gebruiken en accountverwijdering aanvragen via de instellingen, rekening houdend met wettelijke verplichtingen en lopende operaties. Wigofly kan deze voorwaarden om juridische, beveiligings- of dienstredenen wijzigen; belangrijke wijzigingen worden vooraf aangekondigd.',
  ...
  ar: {
    ...
    sections: [
      { id: 'editor', title: '1. الناشر ونطاق التطبيق', paragraphs: [
        'تدير {entity}، ومقرها {address}، والمسجلة تحت {registration}، منصة Wigofly. الاتصال القانوني: {email}.',
        'تنظم هذه الشروط استخدام الموقع والتطبيق وخدمات Wigofly. وتنطبق على المرسلين والمسافرين والمستلمين والزوار. استخدام Wigofly يعني قبولها.',
        'يجب استبدال المعلومات بين القوسين ببيانات الشركة قبل أي افتتاح تجاري.',
      ] },
      { id: 'role', title: '2. دور Wigofly', paragraphs: [
        'يوفر Wigofly أداة للربط والتنسيق والرسائل والتحقق اليدوي ومتابعة العمليات. لا ينقل Wigofly الطرود ولا يفحص محتواها فعليا ولا يحل محل ناقل أو وكيل شحن أو ممثل جمركي.',
      ...
      { id: 'account', title: '3. الحساب والأمان والتحقق', list: [
        ...
        'قد يتطلب نشر الرحلات وبعض الإجراءات التحقق من الهوية. يعالجه Wigofly حاليا، ولن يُذكر مزود خارجي إلا بعد تشغيله فعليا.',
      ...
      { id: 'products', title: '4. المنتجات والتصريحات والجمارك', paragraphs: [
        ...
        'قبول طرد داخل Wigofly لا يعني قبوله تلقائيا في الجمارك. يجب التحقق من قواعد بلد المغادرة والعبور والوصول.',
      ] },
      ...
      { id: 'payment', title: '6. الدفع والرسوم', paragraphs: [
        'الحالة الحالية: وحدة الدفع والضمان محاكاة. لا ينفذ Wigofly أي دفع أو تحصيل أو حجز أو تحويل حقيقي قبل تفعيل مزود دفع معتمد والشروط النهائية.',
        'قبل تفعيل الدفع الحقيقي، سينشر Wigofly اسم المزود والرسوم وشروط الاسترداد ومهل التحويل والمعلومات القانونية المطلوبة. لا يجوز للمستخدمين الدفع لبعضهم خارج الوسائل الرسمية التي يوفرها Wigofly.',
      ] },
      { id: 'chat', title: '7. الرسائل والصور والموقع', list: [
        'يجب أن يبقى التنسيق داخل رسائل Wigofly. قد تُحظر أو تُراقب أرقام الهاتف والبريد والروابط والشبكات الاجتماعية ووسائل الدفع الخارجية لحماية المستخدمين.',
      ...
      { id: 'liability', title: '10. المسؤولية', paragraphs: [
        'في الحدود التي يسمح بها القانون، لا يتحمل Wigofly مسؤولية تصريحات المستخدمين أو جودة المنتج أو تأخر السفر أو قرار جمركي أو اتفاق خارج التطبيق أو ضرر سببه مستخدم.',
      ...
      { id: 'end', title: '11. المدة والإغلاق وتعديل الشروط', paragraphs: [
        'يمكنك التوقف عن استخدام Wigofly وطلب حذف حسابك من الإعدادات، مع مراعاة الالتزامات القانونية والعمليات الجارية. يجوز لـ Wigofly تعديل الشروط لأسباب قانونية أو أمنية أو لتطوير الخدمة، وستُعلن التغييرات المهمة قبل سريانها.',
