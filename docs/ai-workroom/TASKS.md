...
- [doing: claude->codex] Fondation production (PRD P0.1/P0.4/P0.8). Premiere brique
  ...
  (prochains candidats: `settings`/`kycDecisions` ou interface Postgres reelle,
  avant transactions). Codex a ajoute le runtime audit log JSON + endpoint admin
  pour P0.8, puis extrait `auditLogs`, `notifications` et `messages` derriere
  des repositories JSON. Voir `DONE.md` 2026-07-15.
